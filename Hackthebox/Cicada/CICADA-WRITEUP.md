...
- Ataque password sprying con Netexec
...
Viendo que no tenemos permisos de conexión aún, vamos a fijarnos en el backup obtenido del recurso DEV anteriormente:
